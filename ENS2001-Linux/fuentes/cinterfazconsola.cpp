...
int CInterfazConsola::Ejecutar(void)
{
    ...
    {
        conf->BancoRegistros()->Leer(PC,pc);
        Desensamblar(CCadena(pc.Decimal()), (char *) "1");
    }
...
int CInterfazConsola::Ensamblar(CCadena fichero)
{
    ...
    switch(retorno)
    {
        case 0 :  cout<<S_CADENA_002<<lineas<<endl; //Lineas procesadas
                  ...
                  CargarMemoria((char *) FICHERO_TEMPORAL_MEMORIA);
                  conf->BancoRegistros()->Reiniciar();
                  conf->GestorPuntosRuptura()->Reiniciar();
                  return 0;
        case -1 : ListarErrores((char *) FICHERO_TEMPORAL_ERRORES);
...
int CInterfazConsola::EscribirRegistro(CCadena registro,CCadena valor)
{
    ...
    try
    {
        ...
        if(registro.Comparar((char *) "a")==0 || registro.Comparar((char *) "A")==0)
        {
            conf->BancoRegistros()->Escribir(A,num);
        }
        else if(registro.Comparar((char *) "r0")==0 || registro.Comparar((char *) "R0")==0)
        {
            conf->BancoRegistros()->Escribir(R0,num);
        }
        else if(registro.Comparar((char *) "r1")==0 || registro.Comparar((char *) "R1")==0)
        {
            conf->BancoRegistros()->Escribir(R1,num);
        }
        else if(registro.Comparar((char *) "r2")==0 || registro.Comparar((char *) "R2")==0)
        {
            conf->BancoRegistros()->Escribir(R2,num);
        }
        else if(registro.Comparar((char *) "r3")==0 || registro.Comparar((char *) "R3")==0)
        {
            conf->BancoRegistros()->Escribir(R3,num);
        }
        else if(registro.Comparar((char *) "r4")==0 || registro.Comparar((char *) "R4")==0)
        {
            conf->BancoRegistros()->Escribir(R4,num);
        }
        else if(registro.Comparar((char *) "r5")==0 || registro.Comparar((char *) "R5")==0)
        {
            conf->BancoRegistros()->Escribir(R5,num);
        }
        else if(registro.Comparar((char *) "r6")==0 || registro.Comparar((char *) "R6")==0)
        {
            conf->BancoRegistros()->Escribir(R6,num);
        }
        else if(registro.Comparar((char *) "r7")==0 || registro.Comparar((char *) "R7")==0)
        {
            conf->BancoRegistros()->Escribir(R7,num);
        }
        else if(registro.Comparar((char *) "r8")==0 || registro.Comparar((char *) "R8")==0)
        {
            conf->BancoRegistros()->Escribir(R8,num);
        }
        else if(registro.Comparar((char *) "r9")==0 || registro.Comparar((char *) "R9")==0)
        {
            conf->BancoRegistros()->Escribir(R9,num);
        }
        else if(registro.Comparar((char *) "pc")==0 || registro.Comparar((char *) "PC")==0)
        {
            conf->BancoRegistros()->Escribir(PC,num);
        }
        else if(registro.Comparar((char *) "sp")==0 || registro.Comparar((char *) "SP")==0)
        {
            conf->BancoRegistros()->Escribir(SP,num);
        }
        else if(registro.Comparar((char *) "ix")==0 || registro.Comparar((char *) "IX")==0)
        {
            conf->BancoRegistros()->Escribir(IX,num);
        }
        else if(registro.Comparar((char *) "iy")==0 || registro.Comparar((char *) "IY")==0)
        {
            conf->BancoRegistros()->Escribir(IY,num);
        }
        else if(registro.Comparar((char *) "sr")==0 || registro.Comparar((char *) "SR")==0)
        {
